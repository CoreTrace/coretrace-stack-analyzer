...
// Function: overflow_eq_10 (line 19, column 18)
...
// Function: overflow_const_index (line 25, column 15)
//   [!!] potential stack buffer overflow on variable 's' (size 10)
//        alias path: s -> buf
...
// Function: nested_if_overflow (line 34, column 18)
//   [!!] potential stack buffer overflow on variable 's' (size 10)
//        alias path: s -> buf
...
void nested_if_overflow(void)
{
    ...
    if (i > 5 && i <= 15)         // ton analyse de bornes devrait voir UB = 15
        s.buf[i] = 'D';           // overflow
}
