...
static void printHelp()
{
    llvm::outs()
        ...
        << "  --assume-external-frame=<value>\n"
        << "                         Charge <value> per unresolved call (indirect, or to an\n"
        << "                         external declaration) instead of reporting max stack\n"
        << "                         as unknown; 0 ignores such calls\n"
